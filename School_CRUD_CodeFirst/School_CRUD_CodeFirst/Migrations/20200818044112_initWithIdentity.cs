...
namespace School_CRUD_CodeFirst.Migrations
{
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClassRoom_Name = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Teacher_Address = table.Column<string>(nullable: true),
                    Avatar_Path = table.Column<string>(nullable: true),
                    Teacher_Level = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TeacherAndClassRooms", x => new { x.Teacher_Id, x.ClassRoom_Id });
                    table.ForeignKey(
                        name: "FK_TeacherAndClassRooms_ClassRooms_ClassRoom_Id",
                        column: x => x.ClassRoom_Id,
                        principalTable: "ClassRooms",
                        principalColumn: "ClassRoom_Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TeacherAndClassRooms_Teachers_Teacher_Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TeacherAndClassRooms_ClassRoom_Id",
                table: "TeacherAndClassRooms",
                column: "ClassRoom_Id");
        }
